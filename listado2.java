...
public class listado2 extends aseoyhogar {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView((int) C0266R.layout.activity_listado2);
        this.gridView = (GridView) findViewById(C0266R.C0268id.gridView11);
        ...
        try {
            ...
            Cursor cr = db.rawQuery("SELECT * FROM cl ORDER BY codigo", (String[]) null);
    ...
    public void eliminartodo(View v) {
        SQLiteDatabase db = new DBHelper(this, "administracion", (SQLiteDatabase.CursorFactory) null, 1).getWritableDatabase();
        try {
            db.execSQL("DELETE FROM cl WHERE 1");
